...
import { Deliveries } from '../../../../core/models/order.interface';
...
@Component({
  ...
  imports: [AsyncPipe, DeliveryStatusPipe, OrderStatusPipe, DatePipe],
...
export class DeliveriesComponent implements OnInit {
  ...
  loadDeliveries(): void {
    this.deliveryPartnerService.getDeliveries().subscribe({
      next: (deliveries) => {
